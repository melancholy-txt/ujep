...
airmiles.exp <- HoltWinters(airmiles, gamma = FALSE)
airmiles.exp2 <- HoltWinters(airmiles, alpha = 0.2, gamma = FALSE)
plot(airmiles.exp)
plot(airmiles.exp2)
airmiles.exp$SSE
airmiles.exp2$SSE
...
plot(BJsales)
bjsales.exp <- HoltWinters(BJsales, gamma = FALSE)
bjsales.exp2 <- HoltWinters(BJsales, beta = FALSE, gamma = FALSE)
plot(bjsales.exp2)
bjsales.exp.f <- forecast(bjsales.exp, h = 15)
plot(bjsales.exp.f)
bjsales.exp$SSE
bjsales.exp2$SSE
...
plot(AirPassengers)
air.exp <- HoltWinters(AirPassengers, seasonal = "multiplicative")
plot(air.exp)
air.exp
plot(forecast(air.exp, h = 12))
ln.air.ts <- log(AirPassengers)
ln.air.exp <- HoltWinters(ln.air.ts)
plot(ln.air.exp)
# popiste + odhadnete radu fdeaths
  # Monthly Deaths from Lung Diseases in the UK
plot(fdeaths)
fdeaths.exp <- HoltWinters(fdeaths, beta = FALSE)
plot(fdeaths.exp)
fdeaths.exp
