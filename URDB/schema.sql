...
-- Additional race results for remaining drivers in first 5 races (to complete all 20 drivers)

-- Complete Bahrain GP 2024 (remaining drivers 11-20)
INSERT INTO race_results (race_id, driver_id, team_id, starting_position, finishing_position, points_earned, laps_completed, time_gap) VALUES
(1, 3, 3, 11, 11, 0.0, 57, '+1:41.567'),
(1, 4, 4, 12, 12, 0.0, 57, '+1:44.234'),
(1, 5, 4, 13, 13, 0.0, 57, '+1:46.891'),
(1, 11, 9, 14, 14, 0.0, 57, '+1:49.567'),
(1, 12, 9, 15, 15, 0.0, 57, '+1:52.234'),
(1, 14, 7, 16, 16, 0.0, 57, '+1:54.891'),
(1, 15, 8, 17, 17, 0.0, 57, '+1:57.567'),
(1, 16, 8, 18, 18, 0.0, 56, '+1 lap'),
(1, 18, 10, 19, 19, 0.0, 55, '+2 laps'),
(1, 20, 6, 20, 20, 0.0, 54, '+3 laps');

-- Complete Saudi Arabian GP 2024 (remaining drivers 11-20)
INSERT INTO race_results (race_id, driver_id, team_id, starting_position, finishing_position, points_earned, laps_completed, time_gap) VALUES
(2, 3, 3, 11, 11, 0.0, 50, '+1:32.123'),
(2, 4, 4, 12, 12, 0.0, 50, '+1:34.789'),
(2, 5, 4, 13, 13, 0.0, 50, '+1:37.456'),
(2, 10, 5, 14, 14, 0.0, 50, '+1:40.123'),
(2, 12, 9, 15, 15, 0.0, 50, '+1:42.789'),
(2, 15, 8, 16, 16, 0.0, 50, '+1:45.456'),
(2, 16, 8, 17, 17, 0.0, 50, '+1:48.123'),
(2, 18, 10, 18, 18, 0.0, 49, '+1 lap'),
(2, 19, 6, 19, 19, 0.0, 48, '+2 laps'),
(2, 20, 6, 20, 20, 0.0, 47, '+3 laps');

-- Complete Australian GP 2024 (remaining drivers 11-20)
INSERT INTO race_results (race_id, driver_id, team_id, starting_position, finishing_position, points_earned, laps_completed, time_gap) VALUES
(3, 8, 2, 11, 11, 0.0, 58, '+1:05.123'),
(3, 11, 9, 12, 12, 0.0, 58, '+1:07.789'),
(3, 12, 9, 13, 13, 0.0, 58, '+1:10.456'),
(3, 13, 7, 14, 14, 0.0, 58, '+1:13.123'),
(3, 14, 7, 15, 15, 0.0, 58, '+1:15.789'),
(3, 15, 8, 16, 16, 0.0, 58, '+1:18.456'),
(3, 16, 8, 17, 17, 0.0, 58, '+1:21.123'),
(3, 18, 10, 18, 18, 0.0, 57, '+1 lap'),
(3, 19, 6, 19, 19, 0.0, 56, '+2 laps'),
(3, 20, 6, 20, 20, 0.0, 55, '+3 laps');

-- Complete Japanese GP 2024 (remaining drivers 11-20)
INSERT INTO race_results (race_id, driver_id, team_id, starting_position, finishing_position, points_earned, laps_completed, time_gap) VALUES
(4, 5, 4, 11, 11, 0.0, 53, '+1:10.891'),
(4, 10, 5, 12, 12, 0.0, 53, '+1:13.567'),
(4, 11, 9, 13, 13, 0.0, 53, '+1:16.234'),
(4, 12, 9, 14, 14, 0.0, 53, '+1:18.891'),
(4, 14, 7, 15, 15, 0.0, 53, '+1:21.567'),
(4, 15, 8, 16, 16, 0.0, 53, '+1:24.234'),
(4, 16, 8, 17, 17, 0.0, 53, '+1:26.891'),
(4, 18, 10, 18, 18, 0.0, 52, '+1 lap'),
(4, 19, 6, 19, 19, 0.0, 51, '+2 laps'),
(4, 20, 6, 20, 20, 0.0, 50, '+3 laps');

-- Complete Chinese GP 2024 (remaining drivers 11-20)
INSERT INTO race_results (race_id, driver_id, team_id, starting_position, finishing_position, points_earned, laps_completed, time_gap) VALUES
(5, 7, 3, 11, 11, 0.0, 56, '+1:10.234'),
(5, 5, 4, 12, 12, 0.0, 56, '+1:12.891'),
(5, 10, 5, 13, 13, 0.0, 56, '+1:15.567'),
(5, 12, 9, 14, 14, 0.0, 56, '+1:18.234'),
(5, 14, 7, 15, 15, 0.0, 56, '+1:20.891'),
(5, 15, 8, 16, 16, 0.0, 56, '+1:23.567'),
(5, 16, 8, 17, 17, 0.0, 56, '+1:26.234'),
(5, 18, 10, 18, 18, 0.0, 55, '+1 lap'),
(5, 19, 6, 19, 19, 0.0, 54, '+2 laps'),
(5, 20, 6, 20, 20, 0.0, 53, '+3 laps');
